...
#            return
 ...
 #       print(frame_id)
        ...
        #    import pdb
        #    pdb.set_trace()
        if frame_id.endswith(b'/camera_front') or frame_id.endswith(b'/camera_down') or frame_id.endswith(b'/camera_color_optical_frame') or frame_id.endswith(b'/depth_camera_front'):
