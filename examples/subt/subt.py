...
class SubTVer0:
    ...
    def play(self):
        print("Go One Meter!")
        self.send_speed_cmd(1.0, 0.0)
        while self.traveled_dist < 10.0:
            self.update()
...
if __name__ == "__main__":
    ...
    if args.command == 'replay':
        ...
        args.module = 'app'
        game = replay(args, application=SubTVer0)
        game.play()
        ...
        robot = Recorder(config=config['robot'], logger=log, application=SubTVer0)
