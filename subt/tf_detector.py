...
ARTF_NAME = np.array(list(NAMES_AND_SCORES.keys()))
...
class CvDetector:
    def __init__(self):
        ...
        self.cvNet.setPreferableBackend(cv2.dnn.DNN_BACKEND_OPENCV)
        self.cvNet.setPreferableTarget(cv2.dnn.DNN_TARGET_OPENCL)
